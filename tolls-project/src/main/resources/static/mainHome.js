...
var platform = new H.service.Platform({
        apikey: 'QywRO89fdDW6lzkfb5eIlHPf4y4j-I7MjgU3H_aFtSU',
        useCIT: true,
        useHTTPS: secure
    }),
    ...
    map = new H.Map(
        ...
        {
            zoom: 8,
            center: { lat: 41.645284, lng: 21.678669 }
        });
...
var calculateRoute = function (start, destination) {
	...
	&app_id=${app_id}${(finalParamsValue !== '' ? '&' + finalParamsValue : '')}&jsoncallback=parseRoutingResponse`
    //&app_code=${app_code}
